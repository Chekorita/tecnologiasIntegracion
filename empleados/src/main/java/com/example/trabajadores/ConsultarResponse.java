...
public class ConsultarResponse {
    ...
    protected List<ConsultarResponse.Empleados> empleados;
     ...
     * {@link ConsultarResponse.Empleados }
     * 
     * 
     */
    public List<ConsultarResponse.Empleados> getEmpleados() {
        if (empleados == null) {
            empleados = new ArrayList<ConsultarResponse.Empleados>();
        }
