...
@XmlRootElement(name = "ConsultarNombreResponse")
public class ConsultarNombreResponse {

    @XmlElement(required = true)
    protected List<ConsultarNombreResponse.Empleados> empleados;
     ...
     * {@link ConsultarNombreResponse.Empleados }
     * 
     * 
     */
    public List<ConsultarNombreResponse.Empleados> getEmpleados() {
        if (empleados == null) {
            empleados = new ArrayList<ConsultarNombreResponse.Empleados>();
        }
