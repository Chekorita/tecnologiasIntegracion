...
@XmlRootElement(name = "ConsultarPuestoResponse")
public class ConsultarPuestoResponse {

    @XmlElement(required = true)
    protected List<ConsultarPuestoResponse.Empleados> empleados;
     ...
     * {@link ConsultarPuestoResponse.Empleados }
     * 
     * 
     */
    public List<ConsultarPuestoResponse.Empleados> getEmpleados() {
        if (empleados == null) {
            empleados = new ArrayList<ConsultarPuestoResponse.Empleados>();
        }
